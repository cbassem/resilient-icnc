...
//
//	template< class Derived >
//	void resilientContext< Derived >::done(const Tag & tag, const int tagColId, const int nrOfPuts, const int nrOfPrescribes) {
...
//
//	template< class Derived >
//	void resilientContext< Derived >::prescribe(const Tag & prescriber, const int prescriberColId, const Tag & tag, const int tagColId) {
//	    //mutex_t::scoped_lock _l( m_mutex );
//		serializer * ser = dist_context::new_serializer( &m_communicator );
